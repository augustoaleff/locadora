...
Begin VB.Form FrmComRelatCARBuscarNome 
   ...
   End
End
Attribute VB_Name = "FrmComRelatCARBuscarNome"
...
Private Sub MSFlexPesquisa_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        ...
        FrmComRelatCAR.TxtCodCliente.Text = CODIGO
        FrmComRelatCAR.TxtCodCliente_KeyPress (13)
        Unload Me
