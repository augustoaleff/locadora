...
Begin VB.Form FrmComCadProdutosNovoPesquisa 
   ...
   End
End
Attribute VB_Name = "FrmComCadProdutosNovoPesquisa"
...
If ValidaCampos() = True Then
 ...
 If CBoxAleatorio.Value = vbChecked Then
      ...
      reg.Open ("SELECT * FROM PRODUTOS WHERE DESCRICAO LIKE '%" & Trim(TxtDescricao.Text) & "%'")
...
Private Sub MSFlexPesquisa_KeyPress(KeyAscii As Integer)
 ...
 If KeyAscii = 13 Then
  ...
  FrmComCadProdutosNovo.TxtCodigo.Text = CODIGO
  FrmComCadProdutosNovo.TxtCodigo_KeyPress (13)
  Unload Me
