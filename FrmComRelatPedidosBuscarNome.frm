...
Begin VB.Form FrmComRelatPedidosBuscarNome 
   ...
   End
End
Attribute VB_Name = "FrmComRelatPedidosBuscarNome"
...
Private Sub MSFlexPesquisa_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 Then
        ...
        FrmComRelatPedidos.TxtCodCliente.Text = CODIGO
        FrmComRelatPedidos.TxtCodCliente_KeyPress (13)
        Unload Me
